...
public class ClassRoomSpecification implements Specification<ClassRoom> {
    ...
    public static ClassRoomSpecification build(List<SearchCriteria> criterias) {
        return new ClassRoomSpecification(criterias);
    }
    ...
    public static Specification<ClassRoom> listAllByCriteria(List<SearchCriteria> criterias) {
    ...
    private static void buildOrderBy(CriteriaQuery<?> query, List<SearchCriteria> criterias,
                                     Root<ClassRoom> root, CriteriaBuilder builder) {
    ...
    private static Order buildOrder(Root<ClassRoom> root, CriteriaBuilder builder, String order, String field) {
        switch (order) {
    ...
    private static Expression<?> buildExpression(Root<ClassRoom> root, String field) {
    ...
    private static List<Predicate> addPredicates(List<SearchCriteria> criterias, Root<ClassRoom> root, CriteriaBuilder builder) {
        List<Predicate> predicates = new ArrayList<>();
    ...
    private static void addPredicate(Root<ClassRoom> root, CriteriaBuilder builder, List<Predicate> predicates, SearchCriteria criteria) {
